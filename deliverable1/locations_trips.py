...
def main():
    ...
    for filename in filepaths:
        ...
        pickup_location_id = header_list.index('pulocationid')
        dropoff_location_id = header_list.index('dolocationid')
        ...
        values = rows.map(lambda x: (x[pickup_location_id], x[dropoff_location_id])).reduceByKey(add)
